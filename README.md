...
module.compute.data.google_compute_zones.available: Read complete after 0s [id=projects/<gcp-project-id>/regions/us-west2]
...
Terraform will perform the following actions:
  ...
  + resource "google_cloudfunctions2_function" "cloud_function" {
      ...
      + service_config {
          ...
          + service_account_email            = "dev--ro--cloud-function@<gcp-project-id>.iam.gserviceaccount.com"
          + timeout_seconds                  = 60
  ...
  + resource "google_project_iam_member" "cli_admin_logging_viewer" {
      + etag    = (known after apply)
      + id      = (known after apply)
      + member  = "serviceAccount:gcp-cli-admin@<gcp-project-id>.iam.gserviceaccount.com"
      + project = "<gcp-project-id>"
  ...
  + resource "google_project_iam_member" "cloud_function_compute_viewer" {
      + etag    = (known after apply)
      + id      = (known after apply)
      + member  = "serviceAccount:dev--ro--cloud-function@<gcp-project-id>.iam.gserviceaccount.com"
      + project = "<gcp-project-id>"
  ...
  + resource "google_project_iam_member" "compute_viewer" {
      + etag    = (known after apply)
      + id      = (known after apply)
      + member  = "serviceAccount:dev--ro--service-account@<gcp-project-id>.iam.gserviceaccount.com"
      + project = "<gcp-project-id>"
      + role    = "roles/compute.viewer"
    }
  ...
  + resource "google_service_account" "cloud_function" {
      ...
      + email        = "dev--ro--cloud-function@<gcp-project-id>.iam.gserviceaccount.com"
      + id           = (known after apply)
      + member       = "serviceAccount:dev--ro--cloud-function@<gcp-project-id>.iam.gserviceaccount.com"
      + name         = (known after apply)
      + project      = "<gcp-project-id>"
  ...
  + resource "google_service_account" "read_only" {
      ...
      + email        = "dev--ro--service-account@<gcp-project-id>.iam.gserviceaccount.com"
      + id           = (known after apply)
      + member       = "serviceAccount:dev--ro--service-account@<gcp-project-id>.iam.gserviceaccount.com"
      + name         = (known after apply)
      + project      = "<gcp-project-id>"
...
Changes to Outputs:
  ...
  + cloud_function_service_account_email      = "dev--ro--cloud-function@<gcp-project-id>.iam.gserviceaccount.com"
  ...
  + readonly_service_account_email            = "dev--ro--service-account@<gcp-project-id>.iam.gserviceaccount.com"
  ...
  + stressload_function_service_account_email = "dev--ro--cloud-function@<gcp-project-id>.iam.gserviceaccount.com"
  + stressload_key                            = "low"
...
module.profiles.google_project_iam_member.cli_admin_logging_viewer: Creation complete after 7s [id=<gcp-project-id>/roles/logging.viewer/serviceAccount:gcp-cli-admin@<gcp-project-id>.iam.gserviceaccount.com]
...
module.load_balancer.google_compute_health_check.http: Creation complete after 11s [id=projects/<gcp-project-id>/global/healthChecks/dev--http-health-check]
module.profiles.google_service_account.cloud_function: Creation complete after 11s [id=projects/<gcp-project-id>/serviceAccounts/dev--ro--cloud-function@<gcp-project-id>.iam.gserviceaccount.com]
...
module.compute.google_compute_health_check.http: Creation complete after 11s [id=projects/<gcp-project-id>/global/healthChecks/dev--http-health-check-us-west2]
module.profiles.google_service_account.read_only: Creation complete after 13s [id=projects/<gcp-project-id>/serviceAccounts/dev--ro--service-account@<gcp-project-id>.iam.gserviceaccount.com]
...
module.profiles.google_project_iam_member.logging_viewer: Creation complete after 6s [id=<gcp-project-id>/roles/logging.viewer/serviceAccount:dev--ro--service-account@<gcp-project-id>.iam.gserviceaccount.com]
module.profiles.google_project_iam_member.cloud_function_compute_viewer: Creation complete after 8s [id=<gcp-project-id>/roles/compute.viewer/serviceAccount:dev--ro--cloud-function@<gcp-project-id>.iam.gserviceaccount.com]
module.profiles.google_project_iam_member.cloud_function_logging_viewer: Creation complete after 8s [id=<gcp-project-id>/roles/logging.viewer/serviceAccount:dev--ro--cloud-function@<gcp-project-id>.iam.gserviceaccount.com]
module.profiles.google_project_iam_member.compute_viewer: Creation complete after 7s [id=<gcp-project-id>/roles/compute.viewer/serviceAccount:dev--ro--service-account@<gcp-project-id>.iam.gserviceaccount.com]
...
module.profiles.google_project_iam_member.monitoring_viewer: Creation complete after 7s [id=<gcp-project-id>/roles/monitoring.viewer/serviceAccount:dev--ro--service-account@<gcp-project-id>.iam.gserviceaccount.com]
module.profiles.google_project_iam_member.cloud_function_monitoring_viewer: Creation complete after 9s [id=<gcp-project-id>/roles/monitoring.viewer/serviceAccount:dev--ro--cloud-function@<gcp-project-id>.iam.gserviceaccount.com]
module.networking.google_project_service.servicenetworking: Creation complete after 21s [id=<gcp-project-id>/servicenetworking.googleapis.com]
module.cloud_function.google_cloudfunctions2_function.cloud_function: Still creating... [10s elapsed]
module.networking.google_compute_network.vpc_network: Creation complete after 22s [id=projects/<gcp-project-id>/global/networks/dev--webapp-vpc]
...
module.networking.google_compute_router.nat_router: Creation complete after 11s [id=projects/<gcp-project-id>/regions/us-west2/routers/dev--webapp-router]
module.networking.google_compute_router_nat.nat_config: Creating...
module.firewall.google_compute_firewall.allow_ssh_iap: Creation complete after 11s [id=projects/<gcp-project-id>/global/firewalls/dev--allow-ssh-iap]
module.firewall.google_compute_firewall.allow_http_https: Creation complete after 11s [id=projects/<gcp-project-id>/global/firewalls/dev--allow-http-https]
module.firewall.google_compute_firewall.allow_ssh: Creation complete after 11s [id=projects/<gcp-project-id>/global/firewalls/dev--allow-ssh-restricted]
module.networking.google_compute_subnetwork.subnet: Creation complete after 12s [id=projects/<gcp-project-id>/regions/us-west2/subnetworks/dev--webapp-subnet]
module.compute.google_compute_instance_template.web_server: Creating...
module.networking.google_compute_global_address.cloudsql_psa_range: Creation complete after 12s [id=projects/<gcp-project-id>/global/addresses/dev--cloudsql-psa-range]
module.networking.google_service_networking_connection.cloudsql_psa_connection: Creating...
module.compute.google_compute_instance_template.web_server: Creation complete after 2s [id=projects/<gcp-project-id>/global/instanceTemplates/dev--web-server-template--20250402010843051800000001]
...
module.networking.google_compute_router_nat.nat_config: Creation complete after 11s [id=<gcp-project-id>/us-west2/dev--webapp-router/dev--webapp-nat-config]
...
module.compute.google_compute_region_instance_group_manager.web_servers: Creation complete after 21s [id=projects/<gcp-project-id>/regions/us-west2/instanceGroupManagers/dev--web-servers-group]
...
module.cloud_function.google_cloudfunctions2_function.cloud_function: Creation complete after 52s [id=projects/<gcp-project-id>/locations/us-west2/functions/dev--webapp-stress-tester]
...
module.cloud_function.google_cloudfunctions2_function_iam_member.invoker: Creation complete after 4s [id=projects/<gcp-project-id>/locations/us-west2/functions/dev--webapp-stress-tester/roles/cloudfunctions.invoker/allUsers]
module.compute.google_compute_region_autoscaler.web_autoscaler: Creation complete after 11s [id=projects/<gcp-project-id>/regions/us-west2/autoscalers/dev--web-autoscaling]
...
module.load_balancer.google_compute_backend_service.web_backend: Creation complete after 42s [id=projects/<gcp-project-id>/global/backendServices/dev--web-backend-service]
...
module.networking.google_service_networking_connection.cloudsql_psa_connection: Creation complete after 1m12s [id=projects%2F<gcp-project-id>%2Fglobal%2Fnetworks%2Fdev--webapp-vpc:servicenetworking.googleapis.com]
module.load_balancer.google_compute_url_map.default: Still creating... [10s elapsed]
module.load_balancer.google_compute_url_map.default: Creation complete after 11s [id=projects/<gcp-project-id>/global/urlMaps/dev--web-url-map]
...
module.load_balancer.google_compute_target_http_proxy.default: Creation complete after 11s [id=projects/<gcp-project-id>/global/targetHttpProxies/dev--web-http-proxy]
...
module.load_balancer.google_compute_global_forwarding_rule.http: Creation complete after 22s [id=projects/<gcp-project-id>/global/forwardingRules/dev--http-forwarding-rule]
...
cloudsql_psa_range_name = "dev--cloudsql-psa-range"
compute_instance_template = "https://www.googleapis.com/compute/v1/projects/<gcp-project-id>/global/instanceTemplates/dev--web-server-template--20250402010843051800000001"
compute_instance_type = "e2-micro"
compute_web_autoscaler_name = "dev--web-autoscaling"
...
Service Account:  dev--ro--cloud-function@<gcp-project-id>.iam.gserviceaccount.com
...
You can view your function in the Cloud Console here: https://console.cloud.google.com/functions/details/us-west2/dev--webapp-stress-tester?project=<gcp-project-id>
...
serviceConfig:
  ...
  serviceAccountEmail: dev--ro--cloud-function@<gcp-project-id>.iam.gserviceaccount.com
  timeoutSeconds: 60
...
[
  {
    ...
    "status": {
      "healthStatus": [
        {
          "healthState": "HEALTHY",
          "instance": "https://www.googleapis.com/compute/v1/projects/<gcp-project-id>/zones/us-west2-b/instances/dev--web-server-hct4",
...
```json
{
  ...
  "disks": [
    {
      ...
      "mode": "READ_WRITE",
      "source": "https://www.googleapis.com/compute/v1/projects/<gcp-project-id>/zones/us-west2-b/disks/dev--web-server-hct4",
      "type": "PERSISTENT"
    }
  ],
  ...
  "machineType": "https://www.googleapis.com/compute/v1/projects/<gcp-project-id>/zones/us-west2-b/machineTypes/e2-micro",
  "metadata": {
  ...
  "selfLink": "https://www.googleapis.com/compute/v1/projects/<gcp-project-id>/zones/us-west2-b/instances/dev--web-server-hct4",
  ...
  "zone": "https://www.googleapis.com/compute/v1/projects/<gcp-project-id>/zones/us-west2-b"
}
```
...
[
  {
    "member": "serviceAccount:dev--ro--service-account@<gcp-project-id>.iam.gserviceaccount.com",
    "profile": {
      "name": "projects/<gcp-project-id>/serviceAccounts/dev--ro--service-account@<gcp-project-id>.iam.gserviceaccount.com",
      "email": "dev--ro--service-account@<gcp-project-id>.iam.gserviceaccount.com",
  ...
  },
  {
    "member": "serviceAccount:dev--ro--cloud-function@<gcp-project-id>.iam.gserviceaccount.com",
    "profile": {
      "name": "projects/<gcp-project-id>/serviceAccounts/dev--ro--cloud-function@<gcp-project-id>.iam.gserviceaccount.com",
      "email": "dev--ro--cloud-function@<gcp-project-id>.iam.gserviceaccount.com",
...
Exported:
  ...
  iam_scoped_member="dev--ro--service-account@<gcp-project-id>.iam.gserviceaccount.com"
...
No custom IAM roles found in project: <gcp-project-id>
...
[
  {
    "role": "roles/compute.viewer",
    "managed": [
      "serviceAccount:dev--ro--cloud-function@<gcp-project-id>.iam.gserviceaccount.com",
      "serviceAccount:dev--ro--service-account@<gcp-project-id>.iam.gserviceaccount.com"
    ]
  },
  {
    "role": "roles/logging.viewer",
    "managed": [
      "serviceAccount:dev--ro--cloud-function@<gcp-project-id>.iam.gserviceaccount.com",
      "serviceAccount:dev--ro--service-account@<gcp-project-id>.iam.gserviceaccount.com",
      "serviceAccount:gcp-cli-admin@<gcp-project-id>.iam.gserviceaccount.com"
    ]
  },
  {
    "role": "roles/monitoring.viewer",
...
dev--ro--service-account@<gcp-project-id>.iam.gserviceaccount.com
dev--ro--cloud-function@<gcp-project-id>.iam.gserviceaccount.com
...
[
  {
    "service_account": "dev--ro--service-account@<gcp-project-id>.iam.gserviceaccount.com",
    "name": "projects/<gcp-project-id>/serviceAccounts/dev--ro--service-account@<gcp-project-id>.iam.gserviceaccount.com/keys/1627cb49c5b329be92850cf7fe962c11731b9708",
  ...
  {
    "service_account": "dev--ro--cloud-function@<gcp-project-id>.iam.gserviceaccount.com",
    "name": "projects/<gcp-project-id>/serviceAccounts/dev--ro--cloud-function@<gcp-project-id>.iam.gserviceaccount.com/keys/7f65b4d92c23506359ea8b1738c2cd5012caa01e",
    "key_type": "SYSTEM_MANAGED",
    "valid_after": "2025-04-02T01:08:09Z",
...
[
  {
    ...
    "instance": "https://www.googleapis.com/compute/v1/projects/<gcp-project-id>/zones/us-west2-a/instances/dev--web-server-4l2g",
    "instanceStatus": "RUNNING",
    "name": "dev--web-server-4l2g",
    "version": {
      "instanceTemplate": "https://www.googleapis.com/compute/v1/projects/<gcp-project-id>/global/instanceTemplates/dev--web-server-template--20250402010843051800000001"
    }
  },
  {
    "currentAction": "NONE",
...
```json
  {
    ...
    "instance": "https://www.googleapis.com/compute/v1/projects/<gcp-project-id>/zones/us-west2-c/instances/dev--web-server-r8xz",
    "instanceStatus": "RUNNING",
