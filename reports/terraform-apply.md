...
module.cloud_function[0].google_storage_bucket_object.function_archive[0]: Creation complete after 0s [id=dev--cloud-function-bucket-dev--stressload-webservers.zip]
module.profiles.google_project_iam_member.cli_admin_logging_viewer: Creation complete after 8s [id=<gcp-project-name>/roles/logging.viewer/serviceAccount:gcp-cli-admin@<gcp-project-name>.iam.gserviceaccount.com]
module.profiles.google_project_iam_member.cli_admin_storage_admin: Creation complete after 8s [id=<gcp-project-name>/roles/storage.admin/serviceAccount:gcp-cli-admin@<gcp-project-name>.iam.gserviceaccount.com]
...
module.load_balancer.google_compute_health_check.http: Creation complete after 11s [id=projects/<gcp-project-name>/global/healthChecks/dev--http-health-check]
module.compute.google_compute_health_check.http: Creation complete after 11s [id=projects/<gcp-project-name>/global/healthChecks/dev--http-health-check-us-west2]
module.profiles.google_service_account.read_only: Creation complete after 11s [id=projects/<gcp-project-name>/serviceAccounts/dev--ro--service-account@<gcp-project-name>.iam.gserviceaccount.com]
...
module.profiles.google_service_account.cloud_function[0]: Creation complete after 13s [id=projects/<gcp-project-name>/serviceAccounts/dev--ro--cloud-function@<gcp-project-name>.iam.gserviceaccount.com]
...
module.profiles.google_project_iam_member.cloud_function_logging_viewer[0]: Creation complete after 6s [id=<gcp-project-name>/roles/logging.viewer/serviceAccount:dev--ro--cloud-function@<gcp-project-name>.iam.gserviceaccount.com]
module.profiles.google_project_iam_member.compute_viewer: Creation complete after 8s [id=<gcp-project-name>/roles/compute.viewer/serviceAccount:dev--ro--service-account@<gcp-project-name>.iam.gserviceaccount.com]
module.profiles.google_project_iam_member.logging_viewer: Creation complete after 8s [id=<gcp-project-name>/roles/logging.viewer/serviceAccount:dev--ro--service-account@<gcp-project-name>.iam.gserviceaccount.com]
module.profiles.google_project_iam_member.monitoring_viewer: Creation complete after 9s [id=<gcp-project-name>/roles/monitoring.viewer/serviceAccount:dev--ro--service-account@<gcp-project-name>.iam.gserviceaccount.com]
module.profiles.google_project_iam_member.cloud_function_monitoring_viewer[0]: Creation complete after 7s [id=<gcp-project-name>/roles/monitoring.viewer/serviceAccount:dev--ro--cloud-function@<gcp-project-name>.iam.gserviceaccount.com]
...
module.profiles.google_project_iam_member.cloud_function_compute_viewer[0]: Creation complete after 7s [id=<gcp-project-name>/roles/compute.viewer/serviceAccount:dev--ro--cloud-function@<gcp-project-name>.iam.gserviceaccount.com]
module.networking.google_project_service.servicenetworking: Creation complete after 21s [id=<gcp-project-name>/servicenetworking.googleapis.com]
module.networking.google_compute_network.vpc_network: Creation complete after 22s [id=projects/<gcp-project-name>/global/networks/dev--webapp-vpc]
...
module.networking.google_compute_router.nat_router: Creation complete after 11s [id=projects/<gcp-project-name>/regions/us-west2/routers/dev--webapp-router]
module.networking.google_compute_router_nat.nat_config: Creating...
module.networking.google_compute_subnetwork.subnet: Creation complete after 11s [id=projects/<gcp-project-name>/regions/us-west2/subnetworks/dev--webapp-subnet]
module.compute.google_compute_instance_template.web_server: Creating...
module.networking.google_compute_global_address.cloudsql_psa_range: Creation complete after 12s [id=projects/<gcp-project-name>/global/addresses/dev--cloudsql-psa-range]
module.networking.google_service_networking_connection.cloudsql_psa_connection: Creating...
module.compute.google_compute_instance_template.web_server: Creation complete after 2s [id=projects/<gcp-project-name>/global/instanceTemplates/dev--web-server-template--20250407174500889300000001]
module.compute.google_compute_region_instance_group_manager.web_servers: Creating...
module.firewall.google_compute_firewall.allow_http_https: Still creating... [20s elapsed]
module.firewall.google_compute_firewall.allow_ssh: Still creating... [20s elapsed]
module.firewall.google_compute_firewall.allow_ssh_iap: Still creating... [20s elapsed]
module.networking.google_compute_router_nat.nat_config: Still creating... [10s elapsed]
module.firewall.google_compute_firewall.allow_ssh_iap: Creation complete after 21s [id=projects/<gcp-project-name>/global/firewalls/dev--allow-ssh-iap]
module.networking.google_service_networking_connection.cloudsql_psa_connection: Still creating... [10s elapsed]
module.firewall.google_compute_firewall.allow_http_https: Creation complete after 22s [id=projects/<gcp-project-name>/global/firewalls/dev--allow-http-https]
module.firewall.google_compute_firewall.allow_ssh: Creation complete after 22s [id=projects/<gcp-project-name>/global/firewalls/dev--allow-ssh-restricted]
module.networking.google_compute_router_nat.nat_config: Creation complete after 11s [id=<gcp-project-name>/us-west2/dev--webapp-router/dev--webapp-nat-config]
...
module.compute.google_compute_region_instance_group_manager.web_servers: Creation complete after 21s [id=projects/<gcp-project-name>/regions/us-west2/instanceGroupManagers/dev--web-servers-group]
...
module.compute.google_compute_region_autoscaler.web_autoscaler: Creation complete after 11s [id=projects/<gcp-project-name>/regions/us-west2/autoscalers/dev--web-autoscaling]
module.networking.google_service_networking_connection.cloudsql_psa_connection: Still creating... [40s elapsed]
module.networking.google_service_networking_connection.cloudsql_psa_connection: Creation complete after 42s [id=projects%2F<gcp-project-name>%2Fglobal%2Fnetworks%2Fdev--webapp-vpc:servicenetworking.googleapis.com]
...
module.load_balancer.google_compute_backend_service.web_backend: Creation complete after 44s [id=projects/<gcp-project-name>/global/backendServices/dev--web-backend-service]
...
module.load_balancer.google_compute_url_map.default: Creation complete after 11s [id=projects/<gcp-project-name>/global/urlMaps/dev--web-url-map]
...
module.load_balancer.google_compute_target_http_proxy.default: Creation complete after 11s [id=projects/<gcp-project-name>/global/targetHttpProxies/dev--web-http-proxy]
...
module.load_balancer.google_compute_global_forwarding_rule.http: Creation complete after 22s [id=projects/<gcp-project-name>/global/forwardingRules/dev--http-forwarding-rule]
...
cloud_function_bucket = "dev--cloud-function-bucket"
cloud_function_service_account_email = "dev--ro--cloud-function@<gcp-project-name>.iam.gserviceaccount.com"
cloud_function_service_account_unique_id = "101824342671138803473"
cloud_function_tags = tolist([])
cloud_function_upload_target = "module.cloud_function[0].google_storage_bucket_object.function_archive"
cloudsql_psa_range_name = "dev--cloudsql-psa-range"
compute_instance_tags = tolist([
  "ssh-access",
  "dev--http-server",
])
compute_instance_template = "https://www.googleapis.com/compute/v1/projects/<gcp-project-name>/global/instanceTemplates/dev--web-server-template--20250407174500889300000001"
compute_instance_type = "e2-micro"
compute_web_autoscaler_name = "dev--web-autoscaling"
compute_web_server_ip = "https://www.googleapis.com/compute/v1/projects/<gcp-project-name>/regions/us-west2/instanceGroups/dev--web-servers-group"
compute_web_servers_group = "https://www.googleapis.com/compute/v1/projects/<gcp-project-name>/regions/us-west2/instanceGroups/dev--web-servers-group"
environment_config = {
  "description" = "Development environment"
  "id" = "dev"
  "name" = "development"
...
firewall_allow_ssh_iap_tags = tolist([
  "ssh-access",
])
firewall_allow_ssh_tags = tolist([
  "ssh-access",
])
...
http_forwarding_rule_name = "dev--http-forwarding-rule"
http_health_check_name = "dev--http-health-check"
load_balancer_ip = "34.49.100.242"
load_balancer_tags = tolist([
  "dev--load-balancer",
])
nat_name = "dev--webapp-nat-config"
networking_tags = tolist([
  "dev--networking",
])
profiles_tags = tolist([
  "dev--service-accounts",
])
project_id = "<gcp-project-name>"
readonly_service_account_email = "dev--ro--service-account@<gcp-project-name>.iam.gserviceaccount.com"
readonly_service_account_id = "109975425921166456413"
region = "us-west2"
router_name = "dev--webapp-router"
...
stressload_key = "low"
stressload_log_level = "info"
subnet_id = "projects/<gcp-project-name>/regions/us-west2/subnetworks/dev--webapp-subnet"
vpc_network_id = "projects/<gcp-project-name>/global/networks/dev--webapp-vpc"
web_backend_service_name = "dev--web-backend-service"
workspace = "dev"
```
